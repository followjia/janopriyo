...
function resolveColor(color: string): Vector3 {
  if (typeof window === 'undefined') return new Vector3(1, 1, 1);
...
export default function FloatingLines({
  ...
  useEffect(() => {
    ...
    // Use alpha: true for transparency on light backgrounds
